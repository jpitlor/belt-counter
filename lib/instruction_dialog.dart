        ...
        children: [
          RichText(
            text: TextSpan(children: [
              ...
              TextSpan(text: " button to take a picture, and the app will calculate the chain density", style: style)
            ]),
          ),
          Padding(
              padding: EdgeInsets.symmetric(vertical: 16.0),
              child: Text("Adhere to the following instructions to ensure the density gets calculated correctly",
                  style: style)),
          IconList(items: [
